    ...
    if affiliate_url:
        ...
        if domain_match:
            ...
            if len(domain_parts) > 1:
                for single_part in domain_parts:
                    search_keys.append(single_part)
...
EMBEDDED_LOGOS = {
    ...
    "british": "<svg xmlns='http://w3.org' viewBox='0 0 160 50' style='width:100%; height:100%;'><rect width='100%' height='100%' fill='#00247d' rx='6'/><text x='50%' y='55%' font-family='sans-serif' font-weight='bold' font-size='14' fill='#ffffff' text-anchor='middle' dominant-baseline='middle'>ALL BRITISH</text></svg>",
    "uk-38790": "<svg xmlns='http://w3.org' viewBox='0 0 160 50' style='width:100%; height:100%;'><rect width='100%' height='100%' fill='#00247d' rx='6'/><text x='50%' y='55%' font-family='sans-serif' font-weight='bold' font-size='14' fill='#ffffff' text-anchor='middle' dominant-baseline='middle'>ALL BRITISH</text></svg>",
